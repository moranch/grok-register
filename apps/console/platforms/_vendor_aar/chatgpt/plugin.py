...
import secrets
from core._vendor_aar.base_platform import BasePlatform, Account, AccountStatus, RegisterConfig
from core._vendor_aar.base_mailbox import BaseMailbox
from core._vendor_aar.registration import BrowserRegistrationAdapter, OtpSpec, ProtocolMailboxAdapter, ProtocolOAuthAdapter, RegistrationCapability, RegistrationResult
from core._vendor_aar.registration.helpers import resolve_timeout
from core._vendor_aar.registry import register
...
class ChatGPTPlatform(BasePlatform):
    ...
    def check_valid(self, account: Account) -> bool:
        ...
        try:
            from platforms._vendor_aar.chatgpt.payment import fetch_subscription_status_details
            from core._vendor_aar.proxy_pool import proxy_pool
            class _A: pass
            a = _A()
    ...
    def _run_protocol_oauth(self, ctx) -> dict:
        from platforms._vendor_aar.chatgpt.browser_oauth import register_with_browser_oauth
    ...
    def build_protocol_mailbox_adapter(self):
        def _build_worker(ctx, artifacts):
            from platforms._vendor_aar.chatgpt.protocol_mailbox import ChatGPTProtocolMailboxWorker
    ...
    def get_desktop_state(self) -> dict:
        from platforms._vendor_aar.chatgpt.switch import get_codex_desktop_state
    ...
    def _execute_platform_action(self, action_id: str, account: Account, params: dict) -> dict:
        ...
        if action_id == "switch_desktop":
            from platforms._vendor_aar.chatgpt.switch import (
                close_codex_app,
        ...
        if action_id == "upload_cpa":
            from platforms._vendor_aar.chatgpt.cpa_upload import upload_to_cpa, generate_token_json
        ...
        if action_id == "upload_tm":
            from platforms._vendor_aar.chatgpt.cpa_upload import upload_to_team_manager
    ...
    def _handle_query_state(self, account: Account, params: dict) -> dict:
        ...
        from platforms._vendor_aar.chatgpt.switch import fetch_chatgpt_account_state, get_codex_desktop_state, read_current_codex_account
    ...
    def _handle_refresh_token(self, account: Account, params: dict) -> dict:
        ...
        from platforms._vendor_aar.chatgpt.token_refresh import TokenRefreshManager
        manager = TokenRefreshManager(proxy_url=proxy)
        result = manager.refresh_account(a)
        if result.success:
            data = {"access_token": result.access_token, "refresh_token": result.refresh_token}
            try:
                from platforms._vendor_aar.chatgpt.switch import fetch_chatgpt_account_state
    ...
    def _handle_generate_link(self, account: Account, params: dict) -> dict:
        ...
        from platforms._vendor_aar.chatgpt.payment import generate_plus_link, generate_team_link, open_url_incognito
