...
from platforms._vendor_aar.cursor.core import UA, CURSOR
...
class CursorPlatform(BasePlatform):
    ...
    def _run_browser_oauth(self, ctx) -> dict:
        from platforms._vendor_aar.cursor.browser_oauth import register_with_browser_oauth
    ...
    def get_desktop_state(self) -> dict:
        from platforms._vendor_aar.cursor.switch import get_cursor_desktop_state
    ...
    def execute_action(self, action_id: str, account: Account, params: dict) -> dict:
        ...
        if action_id == "switch_account":
            from platforms._vendor_aar.cursor.switch import (
            ...
            from platforms._vendor_aar.cursor.switch import generate_cursor_checkout_link, get_cursor_billing_info
