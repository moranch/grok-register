...
from core._vendor_aar.registration import BrowserRegistrationAdapter, LinkSpec, OtpSpec, ProtocolMailboxAdapter, ProtocolOAuthAdapter, RegistrationCapability, RegistrationResult
...
class TavilyPlatform(BasePlatform):
    ...
    def _run_browser_oauth(self, ctx) -> dict:
        from platforms._vendor_aar.tavily.browser_oauth import register_with_browser_oauth
