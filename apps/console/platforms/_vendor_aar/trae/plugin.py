...
class TraePlatform(BasePlatform):
    ...
    def _run_protocol_oauth(self, ctx) -> dict:
        from platforms._vendor_aar.trae.browser_oauth import register_with_browser_oauth
    ...
    def execute_action(self, action_id: str, account: Account, params: dict) -> dict:
        ...
        if action_id == "switch_account":
            from platforms._vendor_aar.trae.switch import switch_trae_account, restart_trae_ide
            ...
            from platforms._vendor_aar.trae.core import TraeRegister
