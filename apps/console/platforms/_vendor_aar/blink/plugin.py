...
from core._vendor_aar.registration import LinkSpec, ProtocolMailboxAdapter, RegistrationResult
from core._vendor_aar.registry import register
from platforms._vendor_aar.blink.core import BLINK_BASE, BLINK_PRICE_IDS, BlinkRegister, load_blink_account_state
...
class BlinkPlatform(BasePlatform):
    ...
    def build_protocol_mailbox_adapter(self):
        def _build_worker(ctx, artifacts):
            from platforms._vendor_aar.blink.protocol_mailbox import BlinkProtocolMailboxWorker
