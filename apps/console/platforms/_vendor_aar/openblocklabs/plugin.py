...
class OpenBlockLabsPlatform(BasePlatform):
    ...
    def _run_protocol_oauth(self, ctx) -> dict:
        from platforms._vendor_aar.openblocklabs.browser_oauth import register_with_browser_oauth
    ...
    def build_protocol_mailbox_adapter(self):
        def _build_worker(ctx, artifacts):
            from platforms._vendor_aar.openblocklabs.protocol_mailbox import OpenBlockLabsProtocolMailboxWorker
