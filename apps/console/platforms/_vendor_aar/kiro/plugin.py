...
class KiroPlatform(BasePlatform):
    ...
    def _run_protocol_oauth(self, ctx) -> dict:
        from platforms._vendor_aar.kiro.browser_oauth import register_with_browser_oauth
    ...
    def build_browser_registration_adapter(self):
        return BrowserRegistrationAdapter(
            ...
            browser_worker_builder=lambda ctx, artifacts: __import__("platforms._vendor_aar.kiro.browser_register", fromlist=["KiroBrowserRegister"]).KiroBrowserRegister(
                headless=(ctx.executor_type == "headless"),
                proxy=ctx.proxy,
    ...
    def build_protocol_mailbox_adapter(self):
        def _build_worker(ctx, artifacts):
            from platforms._vendor_aar.kiro.protocol_mailbox import KiroProtocolMailboxWorker
    ...
    def check_valid(self, account: Account) -> bool:
        ...
        try:
            from platforms._vendor_aar.kiro.switch import refresh_kiro_token
    ...
    def get_desktop_state(self) -> dict:
        from platforms._vendor_aar.kiro.switch import get_kiro_desktop_state
