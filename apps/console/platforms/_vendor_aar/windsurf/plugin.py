...
from core._vendor_aar.base_platform import Account, AccountStatus, BasePlatform, RegisterConfig
from core._vendor_aar.registration import BrowserRegistrationAdapter, OtpSpec, ProtocolMailboxAdapter, RegistrationResult
from core._vendor_aar.registration.helpers import resolve_timeout
from core._vendor_aar.registry import register
from platforms._vendor_aar.windsurf.core import load_windsurf_account_state
...
class WindsurfPlatform(BasePlatform):
    ...
    def build_protocol_mailbox_adapter(self):
        def _build_worker(ctx, artifacts):
            from platforms._vendor_aar.windsurf.protocol_mailbox import WindsurfProtocolMailboxWorker
    ...
    def build_browser_registration_adapter(self):
        def _build_worker(ctx, artifacts):
            from platforms._vendor_aar.windsurf.browser_register import WindsurfBrowserRegister
    ...
    def get_desktop_state(self) -> dict:
        from platforms._vendor_aar.windsurf.switch import get_windsurf_desktop_state
    ...
    def _handle_switch_desktop(self, account: Account, params: dict) -> dict:
        ...
        """
        from platforms._vendor_aar.windsurf.core import extract_windsurf_account_context
        from platforms._vendor_aar.windsurf.switch import (
    ...
    def _handle_generate_link_browser(self, account: Account, params: dict) -> dict:
        ...
        from platforms._vendor_aar.windsurf.browser_register import generate_checkout_link_via_windsurf_ui
    ...
    def _handle_check_trial(self, account: Account, params: dict) -> dict:
        ...
        from platforms._vendor_aar.windsurf.core import WindsurfClient, extract_windsurf_account_context
    ...
    def _handle_generate_link(self, account: Account, params: dict) -> dict:
        ...
        from platforms._vendor_aar.windsurf.core import WINDSURF_TURNSTILE_SITEKEY, WINDSURF_BASE, WindsurfClient, extract_windsurf_account_context
