...
from core._vendor_aar.registration import OtpSpec, ProtocolMailboxAdapter, RegistrationResult
...
class CerebrasPlatform(BasePlatform):
    ...
    def check_valid(self, account: Account) -> bool:
        ...
        if not api_key:
            return False
        try:
            from core._vendor_aar.executors.protocol import ProtocolExecutor
