...
Usage::
    ...
    from _vendor_aar.providers.registry import register_provider, create_provider, load_all
...
def load_all() -> None:
    ...
    import _vendor_aar.providers.captcha
    import _vendor_aar.providers.proxy
    import _vendor_aar.providers.sms
    import _vendor_aar.providers.mailbox
