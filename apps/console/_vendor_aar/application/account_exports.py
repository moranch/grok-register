...
from _vendor_aar.domain.accounts import AccountExportSelection, AccountRecord
from _vendor_aar.infrastructure.accounts_repository import AccountsRepository
...
def _generate_cpa_token_json(item: AccountRecord) -> dict:
    from platforms._vendor_aar.chatgpt.cpa_upload import generate_token_json
