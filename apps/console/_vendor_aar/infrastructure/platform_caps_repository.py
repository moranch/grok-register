...
from core._vendor_aar.db import PlatformCapabilityOverrideModel, engine
from core._vendor_aar.registry import list_platforms
from _vendor_aar.domain.platform_caps import PlatformCapabilitiesUpdate
