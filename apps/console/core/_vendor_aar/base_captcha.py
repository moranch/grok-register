...
def create_captcha_solver(provider_key: str, extra: dict | None = None) -> BaseCaptcha:
    from _vendor_aar.infrastructure.provider_definitions_repository import ProviderDefinitionsRepository
    from _vendor_aar.infrastructure.provider_settings_repository import ProviderSettingsRepository
    from _vendor_aar.providers.captcha.local_solver import LocalSolverCaptcha
    from _vendor_aar.providers.captcha.manual import ManualCaptcha
    from _vendor_aar.providers.captcha.twocaptcha import TwoCaptcha
    from _vendor_aar.providers.captcha.yescaptcha import YesCaptcha
