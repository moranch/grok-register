...
from core._vendor_aar.tls import insecure_request, mark_session_insecure, suppress_insecure_request_warning
...
def _create_local_ms_pool(extra: dict, proxy: str | None) -> 'BaseMailbox':
    from core._vendor_aar.local_ms_mailbox import LocalMicrosoftMailboxPool
...
def _create_generic_http(extra: dict, proxy: str | None, *, pipeline_config: dict | None = None) -> 'BaseMailbox':
    from core._vendor_aar.generic_http_mailbox import GenericHttpMailbox
