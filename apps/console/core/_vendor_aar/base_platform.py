...
from core._vendor_aar.registration import BrowserRegistrationFlow, ProtocolMailboxFlow, ProtocolOAuthFlow, RegistrationContext, RegistrationResult
...
class BasePlatform(ABC):
    ...
    def __init__(self, config: RegisterConfig = None):
        from core._vendor_aar.registry import get_platform_capabilities
